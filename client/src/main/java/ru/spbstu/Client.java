...
class Client {
  ...
  void run() {
    ...
    // проверка данных (метод CheckData вызывается один раз в день в 00:01:00)
    ...
    _timer.schedule(new CheckData(databaseService), time);     
    ...
    public void run() {
        try {
            ...
            if (!jsonString.equals("")) {
                ...
                System.out.println("11   "+returnChecks);
